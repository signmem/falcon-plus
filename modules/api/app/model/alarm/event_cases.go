...
| host_id        | int(10) unsigned | NO   |     | NULL              |                             |
| ip             | varchar(20)      | NO   |     | NULL              |                             |
| endpoint       | varchar(100)     | NO   | MUL | NULL              |                             |
| buss_name      | varchar(100)     | NO   |     | NULL              |                             |
| grp_id         | int(10) unsigned | NO   |     | NULL              |                             |
...
type EventCases struct {
	...
	IP            string     `json:"ip" grom:"column:ip"`
	Endpoint      string     `json:"endpoint" grom:"column:endpoint"`
	BussName      string     `json:"buss_name" grom:"column:buss_name"`
